...
const NewArrivals = () => {
    ...
    const updateScrollButtons = ()=>{
        ...
        if(container){
            ...
            const rigtScrollable = container.scrollWidth > container.clientWidth + leftScroll;
            setCanScrollLeft(leftScroll > 0)
            setCanScrollRight(rigtScrollable);
        }
        // console.log(
        //     {  
    ...
    <section className='py-16 px-4 lg:px-0'>
        <div className='container mx-auto text-center mb-10 relative'>
            ...
            <p className='text-lg text-gray-600 mb-8'>
                Dicsover the latest styles straigh off the runway, freshly added to keep your wardrobe on the cutting edge of fashion
            </p>
