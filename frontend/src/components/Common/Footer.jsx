    ...
    <div className='container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0'>
        <div>
            ...
            <form className='flex'>
                ...
                focus:outline-none focus:ring-2 focus:ring-gray-500 transistion-all' required />
        ...
        {/* Quick Links */}
        <div>
            <h3 className='text-lg text-gray-800 mb-4'>Quick Links</h3>
            <ul className='space-y-2 text-gray-600'>
                <li>
                    <Link href="#" className='hover:text-gray-500 transition-colors'>Contact Us</Link>
                </li>
                <li>
                    <Link href="#" className='hover:text-gray-500 transition-colors'>About Us</Link>
                </li>
                <li>
                ...
                <li>
                    <Link href="#" className='hover:text-gray-500 transition-colors'>Terms & Conditions</Link>
                    {/* Features */}
                </li>
            </ul>
        </div>
        ...
        <div>
            ...
            <p>
                <FiPhoneCall className='inline-block mr-2' /> 0 123-456-789
            </p>
        </div>
    </div>
